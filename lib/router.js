...
Router.route('/pay_file-disbursement_approved', {
    name:'Pay File Disbursement Approved',
    template:'pay_file-disbursement_approved'
});

Router.route('/disburse_1', {
    name:'Disburse funds step one',
    template:'disburse_funds_step1'
});
